...
Modes:
  --local    Lokale Entwicklungssteuerung: Versionsabgleich, PHP-Lint, Locale-Sanity, Frontend-Asset-Performance, JTL-5.8-Kompatibilität, Secret-Scan, Asset-/Template-Sanity.
